...
from . import OptimisationInputs, Central, CentralDuals, Individual, Isolated, Rural
...
if __name__ == "__main__":
    ...
    elif args.model == 'isolated':
        problem = Isolated(solver=args.solver, inputs=inputs, is_debug=args.is_debug)
