...
class Isolated(GenericModel):
    ...
    def create_model(self, **kwargs):
        ...
        def _no_imports_rec(m, t, u):
            """
            Set REC imports to zero.
            """
            return m.imports_rec[t, u] == 0

        def _no_exports_rec(m, t, u):
            """
            Set REC imports to zero.
            """
            return m.exports_rec[t, u] == 0
        ...
        m._no_imports_rec_eqn = pyo.Constraint(m.time, m.member, rule=_no_imports_rec)
        m._no_exports_rec_eqn = pyo.Constraint(m.time, m.member, rule=_no_exports_rec)
